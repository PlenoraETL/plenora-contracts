...
| `adoption-manifest-v3.schema.json` | Current adoption format, including Python sync/async API modes |
...
Manifest v1 is retained for the historical CLI/SDK-only scope and manifest v2
remains immutable. New component adoption uses manifest v3.
